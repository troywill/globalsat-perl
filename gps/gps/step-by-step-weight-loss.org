...
* [8/8] Layout to work with Bootstrap
  ...
  8. [X] Deploy to Heroku
     #+BEGIN_SRC sh
       ...
       git push heroku master
     #+END_SRC
* [10/10] Create "Locations" model, controller, and views
  1. [X] Generate location scaffold
     #+BEGIN_SRC sh :tangle bin/generate-scaffold-location.sh :shebang #!/bin/sh
  ...
  11. [X] Deploy to Heroku
      #+BEGIN_SRC sh
        ...
        run rake db:migrate
      #+END_SRC
* [0/2] Create a "reverse" controller
  1. [ ] Generate controller and view
     #+BEGIN_SRC sh
       rails generate controller reverse index --skip-stylesheets --skip-javascripts
     #+END_SRC
  2. [ ] Write HTML
